<?php
/**
 * Title: Row with three featured items, each with an image.
 * Slug: susurrus/general-featured-items-image-3
	...
	<div class="wp-block-column"
		...
		<div class="wp-block-group has-heading-6-font-size" style="min-height:100%;margin-top:0;margin-bottom:0">
			...
			<div class="wp-block-group" style="margin-top:0;margin-bottom:0">
				...
				<div class="wp-block-group">
					<!-- wp:heading {"fontSize":"heading-4"} -->
					<h2 class="wp-block-heading has-heading-4-font-size">Block Three</h2>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
			</div>
