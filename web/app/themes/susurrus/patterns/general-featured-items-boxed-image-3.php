<?php
/**
 * Title: Row with three featured items, each with background color and an image.
 * Slug: susurrus/general-featured-items-boxed-image-3
		...
		<div class="wp-block-group has-30-background-color has-background has-border-radius-font-size"
			...
			<div class="wp-block-group" style="margin-top:0;margin-bottom:0">
				...
				<div class="wp-block-group"
					...
					<h2 class="wp-block-heading has-heading-5-font-size">Block One</h2>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-group"
				...
				<p class="has-small-font-size">Lorem ipsum dolor sit amet, consect adipisicing elit, sed do eiusmo
		...
		<div class="wp-block-group has-30-background-color has-background has-border-radius-font-size"
			...
			<div class="wp-block-group" style="margin-top:0;margin-bottom:0">
				...
				<div class="wp-block-group"
					style="padding-right:var(--wp--preset--spacing--body-margin);padding-left:var(--wp--preset--spacing--body-margin)">
					<!-- wp:heading {"fontSize":"heading-5"} -->
					<h2 class="wp-block-heading has-heading-5-font-size">Block Two</h2>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
			</div>
		...
		<div class="wp-block-group has-30-background-color has-background has-border-radius-font-size"
			...
			<div class="wp-block-group" style="margin-top:0;margin-bottom:0">
				...
				<div class="wp-block-group"
					style="padding-right:var(--wp--preset--spacing--body-margin);padding-left:var(--wp--preset--spacing--body-margin)">
					<!-- wp:heading {"fontSize":"heading-5"} -->
					<h2 class="wp-block-heading has-heading-5-font-size">Block Three</h2>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
			</div>
