 ...
 * Slug: susurrus/cta-large-boxed-image-right
 * Categories: susurrus, susurrus-cta
 * Viewport width: 1200
 */
?>

<!-- wp:media-text {"align":"wide","mediaPosition":"right","mediaType":"image","imageFill":true,"backgroundColor":"30"} -->
<div
	class="wp-block-media-text alignwide has-media-on-the-right is-stacked-on-mobile is-image-fill has-30-background-color has-background">
